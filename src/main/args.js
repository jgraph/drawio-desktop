...
const OPTION_DEFS = [
	...
	{              long: '--timeout',           key: 'timeout',        takesValue: true,
	  valueLabel: '<seconds>',
	  parse: v => /^\d+$/.test(v) ? parseInt(v, 10) : null,           default: 0,
	  desc: 'fails the export of a file that takes longer than the given number of seconds and continues with the next file (default: 0, no limit)' },
