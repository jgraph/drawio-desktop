...
`npm test` runs the CLI argument parsing tests (`src/test/cli-args.test.js`, Node's built-in test runner). Everything else is manual testing, documented in `doc/RELEASE_PROCESS.md`:
